...
export default function ChatWidget() {
  ...
  return (
    <>
      ...
      {/* Khung chat */}
      {open ? (
        <div className="fixed bottom-24 right-6 z-50 flex h-[520px] w-[360px] max-w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-2xl border border-[#0a1628]/10 bg-white shadow-2xl">
          {/* Header */}
