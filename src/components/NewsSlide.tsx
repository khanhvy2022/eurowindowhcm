              ...
              <SwiperSlide key={article.title}>
                <article className="group">
                  <div className="aspect-[1.45] overflow-hidden bg-[#152238] relative">
                    <img src={article.image} alt={article.title} loading="lazy" decoding="async" className="h-full w-full object-cover transition duration-700 group-hover:scale-105" />
