...
const CATEGORY_KEY = "cua-tu-dong";
const SLUG = "cua-tu-dong";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const imageUrl = `${SITE_URL}${_CAT?.image ?? "/eurowindow/cua-tu-dong.jpg.webp"}`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        vi: canonical,
        en: `${SITE_URL}/en/products/cua-tu-dong`,
        "x-default": canonical,
      },
    },
    openGraph: {
...
export default async function ProductPage() {
  ...
  const collectionSchema = {
    ...
    image: imageUrl,
    publisher: { "@type": "Organization", name: "Cửa Eurowindow Hồ Chí Minh", url: SITE_URL },
    breadcrumb: {
      "@type": "BreadcrumbList",
      itemListElement: [
  ...
  return (
    <>
      ...
      <ProductArticlePage article={article} label={LABEL} bgImage={BANNER_IMG} currentHref={CURRENT_HREF} categoryKey={CATEGORY_KEY} />
    </>
  );
}
