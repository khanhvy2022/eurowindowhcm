...
const CATEGORY_KEY = "cua-nhua-upvc";
const SLUG = "cua-nhua-upvc";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const imageUrl = `${SITE_URL}${_CAT?.image ?? "/eurowindow/cuanhua1.jpg.webp"}`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        vi: canonical,
        en: `${SITE_URL}/en/products/cua-upvc`,
        "x-default": canonical,
      },
    },
    openGraph: {
